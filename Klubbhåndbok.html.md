...
<!\[if !supportLists\]>· <!\[endif\]>Oppnevne to personer som i fellesskap skal disponere idrettslagets konti, og sørge for at de er dekket av underslagsforsikring
...
<!\[if !supportLists\]>• <!\[endif\]>Påse at instruktørene/trenerne og andre verv har nødvendig utdanning og autorisasjon
...
<!\[if !supportLists\]>• <!\[endif\]>Ansvar for å lese og administrere klubbmail
...
<!\[if !supportLists\]>• <!\[endif\]>Skaffe tidtakere til egne stevner, pålagte eksterne stevner, samt forestå salg og servering ved stevnene
...
<!\[if !supportLists\]>· <!\[endif\]>IT gruppe
...
<!\[if !supportLists\]>• <!\[endif\]>Delta i planlegging og arrangering av stevner, leire og arrangementer i regi av klubben.
...
<!\[if !supportLists\]>· <!\[endif\]>Sende ut informasjon om stevnet og oppholdet til hele foreldregruppen en uke før, med klar beskjed hvilke foreldre som er ansvarlig på turen
...
<!\[if !supportLists\]>· <!\[endif\]>Ansvarlige for reise i regi klubben skal alltid være edru.
...
<!\[if !supportLists\]>9. <!\[endif\]>Vær varsom med å sende e-post hvis du er opprørt eller irritert. E-postmeldinger er ”evige” og bør tåle dagens lys uansett sammenheng. Tenk deg om!
...
<!\[if !supportLists\]>10. <!\[endif\]>Reiseleder skaffer seg oversikt over stedet og gir beskjed om hvor deltakerne skal sove, sanitærforhold og hvor man skal spise. Dette gis det beskjed om.
...
<!\[if !supportLists\]>• <!\[endif\]>Være oppdatert på informasjon om utdanning fra forbund og krets
...
<!\[if !supportLists\]>· <!\[endif\]>Presenter hvem som har sittet i valgkomiteen og hvordan arbeidet har foregått.
...
<!\[if !supportLists\]>¨ <!\[endif\]>**Bredde/Masters tilbud**  
...
<!\[if !supportLists\]>• <!\[endif\]>barna kan velge om, og hvor mye de vil konkurrere.
...
<!\[if !supportLists\]>• <!\[endif\]>Perfeksjonering av teknikk innenfor alle svømmearter, med individuell oppfølging.
...
<!\[if !supportLists\]>• <!\[endif\]>Hvordan leve som elite-utøver.
...
<!\[if !supportLists\]>• <!\[endif\]>At utøverne har særdeles høy motivasjon, samt vilje og evne til å prioritere svømming på høyt nivå.

<!\[if !supportLists\]>• <!\[endif\]>At utøverne fremstår som forbilder for yngre utøvere og ”ambassadører” for klubben!
...
<!\[if !supportLists\]>• <!\[endif\]>Vi markerer oss i som en av de kommende klubbene i LÅMØ/ÅM/UM

<!\[if !supportLists\]>• <!\[endif\]>LÅMØ - topp 3

<!\[if !supportLists\]>• <!\[endif\]>ÅM - topp 6

### Mellomlangsiktige mål (2017/2019)

<!\[if !supportLists\]>• <!\[endif\]>Vi er etablert som en sentral klubb i LÅMØ/ÅM/UM med stafettlag som er i finale heat

<!\[if !supportLists\]>• <!\[endif\]>Vi tar medaljer i LÅMØ/ÅM/UM (topp 6 klubb)

<!\[if !supportLists\]>• <!\[endif\]>Vi har landslags utøvere

<!\[if !supportLists\]>• <!\[endif\]>Vi markerer oss som en av de kommende klubbene i Jr/Sr NM (topp 12 Junior NM)

### Langsiktige mål (2020->)

<!\[if !supportLists\]>• <!\[endif\]>Vi er etablert som en sentral klubb i Jr/Sr NM med stafettlag som er i finale heat

<!\[if !supportLists\]>• <!\[endif\]>Vi tar medaljer i Jr/Sr NM

<!\[if !supportLists\]>• <!\[endif\]>Vi er synlige i internasjonale mesterskap
...
<!\[if !supportLists\]>a) <!\[endif\]>Organisering av grupper? En konkurransegruppe til. Få flere i tidlig alder på stevner

<!\[if !supportLists\]>b) <!\[endif\]>Trenerrollene Skikkelig avklart? Nei  Må spesifiseres.

<!\[if !supportLists\]>c) <!\[endif\]>Trengs Flere trenere? Ja

<!\[if !supportLists\]>d) <!\[endif\]>Hvordan skaffe eierskap for alle involvert?
...
<!\[if !supportLists\]>• <!\[endif\]>For Konkurransegruppe A og Elitegruppe B, er oppmøtekravet på 75 %.

<!\[if !supportLists\]>• <!\[endif\]>For Elitegruppe A er oppmøtekravet 90 %.
...
<!\[if !supportLists\]>• <!\[endif\]>Følgende svømmetreninger gjelder for Elite  
  
<!\[if !vml\]>![](Klubbhåndbok.fld/image007.png)<!\[endif\]>  
<!\[if !supportLineBreakNewLine\]>  
<!\[endif\]>

<!\[if !supportLists\]>• <!\[endif\]>Følgende svømmetreninger gjelder for Konkurranse  
  
<!\[if !vml\]>![](Klubbhåndbok.fld/image009.png)<!\[endif\]>

<!\[if !supportLists\]>· <!\[endif\]>Følgende  morgentreninger inngår:

<!\[if !supportLists\]>o <!\[endif\]>2 morgentreninger for Elitegruppe A.

<!\[if !supportLists\]>o <!\[endif\]>1 morgentrening for Elitegruppe B, fra og med det året de fyller 15 år.

<!\[if !supportLists\]>• <!\[endif\]>Ukentlige basistreninger, hvor følgende inngår:

<!\[if !supportLists\]>o <!\[endif\]>4 basistreninger for Elitegruppe A.

<!\[if !supportLists\]>o <!\[endif\]>3 basistreninger for Elitegruppe B.

<!\[if !supportLists\]>o <!\[endif\]>2 basistreninger for Konkurransegruppe A.

<!\[if !supportLists\]>• <!\[endif\]>De stevner/konkurranser gruppen er påmeldt.

<!\[if !supportLists\]>• <!\[endif\]>Treninger på treningssamlinger i høst-, vinter- og påskeferie, samt oppstarts leir (august).
...
<!\[if !supportLists\]>• <!\[endif\]>Fravær som følge av sykdom.

<!\[if !supportLists\]>• <!\[endif\]>Fravær som følge av deltagelse i dåp, konfirmasjon, bryllup, etc.

<!\[if !supportLists\]>• <!\[endif\]>Fravær i forbindelse med ferie. For utøvere på Elitegruppe A, er dette inntil 3 uker etter NM langbane (juli) og inntil 1 uke etter Junior NM (november) og Senior NM (mars), dvs. inntil 5 uker totalt.

<!\[if !supportLists\]>• <!\[endif\]>Fravær i forbindelse med forberedelser til avsluttende prøver/eksamener ved skolegang.
...
<!\[if !supportLists\]>- <!\[endif\]>Bryst

<!\[if !supportLists\]>- <!\[endif\]>Rygg

<!\[if !supportLists\]>- <!\[endif\]>Fri

<!\[if !supportLists\]>- <!\[endif\]>Butterfly

<!\[if !supportLists\]>- <!\[endif\]>Medley

<!\[if !supportLists\]>- <!\[endif\]>Høyest poengsum
...
<!\[if !supportLists\]>- <!\[endif\]>Resultater

<!\[if !supportLists\]>- <!\[endif\]>Fremgang

<!\[if !supportLists\]>- <!\[endif\]>Oppmøte

<!\[if !supportLists\]>- <!\[endif\]>Treningsinnsats

<!\[if !supportLists\]>- <!\[endif\]>Motivasjon av andre svømmere
...
<!\[if !supportLists\]>1) <!\[endif\]>Oppslag korridor ved solarium

<!\[if !supportLists\]>2) <!\[endif\]>Premieutdeler
...
<!\[if !supportLists\]>- <!\[endif\]>Dommerne

<!\[if !supportLists\]>- <!\[endif\]>Trenerne

<!\[if !supportLists\]>- <!\[endif\]>Styret
...
<!\[if !supportLists\]>· <!\[endif\]>Ansatt, tillitsvalgt, utøvere, representant, engasjert leder eller trener skal komme opplagte og edru til trening, konkurranse, o.l.

<!\[if !supportLists\]>· <!\[endif\]>Ingen ansatt, tillitsvalg, utøvere, representant, engasjert leder, foreldre eller trener skal omgås utøvere under 18 år i påvirket tilstand.

<!\[if !supportLists\]>· <!\[endif\]>Det er alltid ansvarlige edru voksne på reiser i regi av klubben

<!\[if !supportLists\]>· <!\[endif\]>Trenere, ledere, foreldre og utøvere skal fremstå som gode forbilder og skal ikke drikke alkohol, eller omtale hendelser/fester hvor alkohol står sentralt, i samvær med utøvere eller barn og unge under 18 år.
...
<!\[if !supportLists\]>• <!\[endif\]>100% av utgiftene begrenset oppad til kr 10.000,- i senior klassen

<!\[if !supportLists\]>• <!\[endif\]>100% av utgiftene begrenset oppad til kr 5.000,-  i junior eller ungdoms klasse

Utøvere som er kvalifisert til 1 eller flere individuelle øvelser får

<!\[if !supportLists\]>• <!\[endif\]>1 krav – 20% av utgiftene begrenset oppad til kr 1.000

<!\[if !supportLists\]>• <!\[endif\]>2 krav – 40% av utgiftene begrenset oppad til kr 2.000

<!\[if !supportLists\]>• <!\[endif\]>3 krav – 60% av utgiftene begrenset oppad til kr 3.000

<!\[if !supportLists\]>• <!\[endif\]>4 krav – 80% av utgiftene begrenset oppad til kr 4.000

<!\[if !supportLists\]>• <!\[endif\]>5 krav – 100% av utgiftene begrenset oppad til kr 5.000

## Årsklasse Mønstring (ÅM)

Utøvere som er rangert topp 6 innenfor sin klasse får

<!\[if !supportLists\]>• <!\[endif\]>100% av utgiftene begrenset oppad til kr 1.500 til ÅM

Utøvere som er kvalifisert får

<!\[if !supportLists\]>• <!\[endif\]>100% av utgiftene begrenset oppad til kr 1.000 til ÅM

Disse retningslinjene er normgivende og støtte må besluttes av styret forut for mesterskap
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk2Nzg5NTM5Nl19
-->